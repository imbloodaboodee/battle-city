...
public class GameGuideScreen extends JPanel {
    ...
    public GameGuideScreen(Runnable onEnterPress) {
        ...
        JLabel imageLabel1 = new JLabel(resizeImageIcon(new ImageIcon("./src/assets/image/move.png"), 0.3));
        ...
        JLabel imageLabel2 = new JLabel(resizeImageIcon(new ImageIcon("./src/assets/image/fire.png"), 0.3));
    ...
    public static Font loadFont() {
        try {
            Font font = Font.createFont(Font.TRUETYPE_FONT, new File("./src/assets/font/prstart.ttf")).deriveFont(Font.PLAIN, 15);

...
public class TankSpawner {
    ...
    private void spawnBasicTank() {
        ...
        DumbTank basicTank = new DumbTank(spawnPoint.x, spawnPoint.y, 3, 1, BulletType.NORMAL, new ImageIcon("./src/jsd/project/tank90/assets/image/tank_basic.png"));
    ...
    private void spawnFastTank() {
        Point spawnPoint = findSpawnPoint();
        DumbTank fastTank = new DumbTank(spawnPoint.x, spawnPoint.y, 3, 3, BulletType.NORMAL, new ImageIcon("./src/jsd/project/tank90/assets/image/tank_fast.png"));
        GameScreen.animations.add(new SpawnAnimation(spawnPoint.x,spawnPoint.y, 200, 1,false));
    ...
    private void spawnPowerTank() {
        Point spawnPoint = findSpawnPoint();
        SmartTank powerTank = new SmartTank(spawnPoint.x, spawnPoint.y, 3, 1, BulletType.NORMAL, new ImageIcon("./src/jsd/project/tank90/assets/image/tank_power_base.png"), new ImageIcon("./src/jsd/project/tank90/assets/image/tank_power_cannon.png"));
        GameScreen.animations.add(new SpawnAnimation(spawnPoint.x,spawnPoint.y, 200, 1,false));
    ...
    private void spawnArmorTank() {
        Point spawnPoint = findSpawnPoint();
        SmartTank armorTank = new SmartTank(spawnPoint.x, spawnPoint.y, 3, 1, BulletType.NORMAL, new ImageIcon("./src/jsd/project/tank90/assets/image/tank_armor_base.png"), new ImageIcon("./src/jsd/project/tank90/assets/image/tank_armor_cannon.png"));
        GameScreen.animations.add(new SpawnAnimation(spawnPoint.x,spawnPoint.y, 200, 1,false));

...
public class BlockExplosion extends Animation {
    ...
    private static BufferedImage[] loadExplosionFrames() {
        ...
        try {
            frames[0] = ImageIO.read(new File("./src/assets/image/block_explosion_1.png"));
            frames[1] = ImageIO.read(new File("./src/assets/image/block_explosion_2.png"));
            frames[2] = ImageIO.read(new File("./src/assets/image/block_explosion_3.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return frames;
